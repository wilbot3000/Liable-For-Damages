...
thanks so much for coming to my game, the git repository only includes the source code, but you can play the full release here:
https://wilbot3000.itch.io/liable-for-damages
...
Game file should be accessible to people on MacOS and windows, but I don't know if the mac version works. All that's on Itch
Thanks again! 
